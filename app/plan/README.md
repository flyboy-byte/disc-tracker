...
| [`docs/data-audit-scope.md`](./docs/data-audit-scope.md) | Low-level | Suggest-engine Phase 2 — missing weight/plastic + wear-level, scoped, not started |
| [`docs/website-parity-scope.md`](./docs/website-parity-scope.md) | Low-level | Website (Flask) parity catch-up — scoped, not started |

...
export interface UserMeta {
  ...
  // catalog-v2-scope.md — state for the last successfully-activated downloaded catalog pack.
  // All null until a user downloads one; src/catalog/ is the only writer.
